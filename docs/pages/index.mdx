...
- <span style={{ display: 'inline-flex', gap: '1ch', verticalAlign: 'top' }}><AppIcon /> <strong>App or</strong> <PagesIcon /> <strong>Pages Router:</strong> With support for React Server Components</span>
